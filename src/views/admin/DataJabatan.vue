<template>
  <div class="container">
    <div
      ...
      <span class="text-lg font-bold">Tambah Data Jabatan</span>
      <div class="pt-4">
        <div class="mb-6 pt-2">
          <form @submit.prevent="submitPosisi">
            <label for="posisi-input" class="block mb-3 text-lg font-medium text-gray-500 dark:text-white">
              Jabatan
            </label>
            <input type="text" id="posisi-input" placeholder="Masukkan Nama Jabatan" v-model="Dataposisi.jabatan"
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10">
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr v-for="(posisi, index) in paginatedPositions" :key="posisi.uuid"
...
export default {
  ...
  methods: {
    ...mapActions('posisi', ['AddPosisi', 'fetchPosisi', 'deletePosition']),
    async submitPosisi() {
      try {
        this.isLoading = true;
