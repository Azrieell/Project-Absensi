    ...
    export default {
        ...
        methods: {
            ...
            async addInformationEmployee() {
                try {
                    const isPermissionAlreadyExist = await this.checkPermissionExistenceForDate(this.informationData
                        .tgl_keterangan);
                    if (isPermissionAlreadyExist) {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Perhatian!',
                            text: 'Anda hanya bisa mengisi keterangan izin satu kali dalam satu hari.',
                        });
                        this.$router.push({
                            name: 'HomeKaryawan'
                        });
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'Anda berhasil mengisi keterangan Izin',
                        });
                        this.$router.push({
                            name: 'HomeKaryawan'
                        });
