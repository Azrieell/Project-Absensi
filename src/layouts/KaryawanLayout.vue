<template>
  <div class="relative">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="absolute top-8 sm:-top-20 left-0 w-full -mt-8 wave-svg">
    ...
    <router-link to="/karyawan/profile">
      <button>
        <div class="absolute flex flex-row-reverse -top-0 right-0 mr-8 mt-5 sm:mt-12 responsive-profile">
          <img :src="employee.url || 'https://i.pinimg.com/originals/c6/e9/ed/c6e9ed167165ca99c4d428426e256fae.png' "
            class="w-14 border-4 border-white rounded-full">
        </div>
      </button>
    </router-link>
