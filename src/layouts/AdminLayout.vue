  ...
  <div class="w-full h-full">
    <div class="flex flex-no-wrap">
      <div style="min-height: auto;"
        class="w-64 bg-gray-800 shadow flex-col justify-between">
        <div class="fixed px-7">
          ...
          <ul class="mt-12">
            ...
            <li class="flex w-full justify-between text-white hover:text-gray-300 cursor-pointer items-center mb-8">
              <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-bar-chart"
                  viewBox="0 0 16 16">
                  <path
      ...
      <div class="min-h-screen md:w-4/5 w-11/12 px-6 py-5">
